...
def main():
    ...
    plt.figure(figure_frequency_domain_1.number)
    figure_frequency_domain_1 = plot_frequency_domain(np.abs(fft_data_clarified1), freqs1, legend="improved1cm.wav",
                                                      figure=figure_frequency_domain_1)
    plt.figure(figure_frequency_domain_2.number)
    figure_frequency_domain_2 = plot_frequency_domain(np.abs(fft_data_clarified2), freqs2, legend="improved1m.wav",
                                                      figure=figure_frequency_domain_2)
