...
def my_fft(data, rate):
    ...
    fft_data = (np.fft.fft(data[:, 0])) / len(data)
...
def clarify_sound(fft_data, sampling_rate, low_freq, high_freq, damping_factor = 0.11, boost_factor = 100_000_000):
...
# plot_time_domain(data1_ifft, time1, "Time domain of sound1.wav after fft")
# plot_time_domain(data2_ifft, time2, "Time domain of sound2.wav after fft")

#' Clarify the sound
fft_data1_clarified = clarify_sound(fft_data1, rate1, 1000, 5000, damping_factor=0.5, boost_factor=10)
fft_data2_clarified = clarify_sound(fft_data2, rate2, 1000, 5000, damping_factor=0.9, boost_factor=10)
...
#' remove noise
data_noise_removed1 = remove_noise(0, 100, fft_data1_clarified, rate1, damping_factor=0.01)
max_freq1 = index_to_freq(len(fft_data1)-1, rate1, len(fft_data1))
data_noise_removed1 = remove_noise(10000, max_freq1, data_noise_removed1, rate1, damping_factor=0.01)

data_noise_removed2 = remove_noise(0, 100, fft_data2_clarified, rate2, damping_factor=0.01)
max_freq2 = index_to_freq(len(fft_data2)-1, rate2, len(fft_data2))
data_noise_removed2 = remove_noise(10000, max_freq2, data_noise_removed2, rate2, damping_factor=0.01)
